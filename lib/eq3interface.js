...
module.exports = {
  ...
  parseInfo: function(info) {
    try{
      switch(info[0]){
          case 0: return this.parseInfo_0(info);
          case 1: return this.parseSysInfo(info);
          case 2:
              switch(info[1] & 0xf){
                  case 1: return this.parseStatus(info); // contains status
                  case 2: return this.parseScheduleSetResp(info); // schedule set response, returns day set
                      break;
              }
              if (info[1] == 0x80) {
              ...
              break;
          case 4: return this.parseTimeRequest(info); // time request?
          case 0x21: return this.parseScheduleReqResp(info); // response to a schedule request
          case 0xa0: return this.parseStartFirmwareUpdate(info);
          case 0xa1: return this.parseContinueFirmwareUpdate(info);
              break;
      }
